...
export const metadata: Metadata = {
  title: "Facebook Video Downloader | QuickVid",
  description:
    "Process supported public Facebook video URLs with QuickVid.",
};
    ...
    <main className="min-h-screen bg-slate-950 px-5 py-20 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 rounded-3xl border border-white/10 bg-white/5 p-8 md:p-12">
          <div className="mb-4 inline-flex rounded-full border border-blue-400/20 bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-300">
            Facebook
          </div>
          ...
          <p className="mt-5 text-lg leading-8 text-slate-400">
            Use QuickVid to process supported public Facebook video
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-black/20 p-8">
            ...
            <ol className="mt-5 list-decimal space-y-3 pl-5 text-slate-400">
              <li>Copy the public Facebook video URL.</li>
              <li>Open QuickVid.</li>
              <li>Paste the URL.</li>
